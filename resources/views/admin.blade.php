...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>Pencari Kerja</b></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Daftar Pekerjaan</span>
            <span class="pull-right-container">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="#" class="small-box-footer">Details <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
        ...
        <section class="col-lg-9 connectedSortable">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Input Pencari Kerja</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form">
